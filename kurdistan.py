...
def main_apv():
    ...
    try:
        ...
        print ("     Copy Key And Sent Me meessage on telegram : Approvel Your Key ")
        ...
        os.system('am start https://t.me/A7AM_M_A?text=' + tks)

        

    r1=requests.get("https://github.com/ahmadfatah99/ahmad/blob/main/a.txt").text
    ...
    if key1 in r1:
        ...
        print ("     Copy Key And Sent Me tl Approvel Your Key ")
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : facebook.com/fmerror69
...
def dupcutter():
	...
	os.system("xdg-open https://t.me/A7AM_M_A")
